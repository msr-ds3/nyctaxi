...
\author{%
\normalsize{\textbf{Abraham Neuwirth}}\\ % Your name
\small Touro College \\ % Your institution
%\normalsize \href{mailto:john@smith.com}{john@smith.com} % Your email address
\and % Uncomment if 2 authors are required, duplicate these 4 lines if more
\normalsize{\textbf{Fatima Chebchoub}}\\ % Second author's name
\small NYC College of Technology\\ % Second author's institution
%\normalsize \href{mailto:jane@smith.com}{jane@smith.com} % Second author's email address
\and % Uncomment if 2 authors are required, duplicate these 4 lines if more
\normalsize{\textbf{Jai Punjwani}}\\% Second author's name
\small Adelphi University\\ % Second author's institution
%\normalsize \href{mailto:jane@smith.com}{jane@smith.com} % Second author's email address
\and % Uncomment if 2 authors are required, duplicate these 4 lines if more
\normalsize{\textbf{Marieme Toure}}\\ % Second author's name
\small NYC College of Technology\\ % Second author's institution
%\normalsize \href{mailto:jane@smith.com}{jane@smith.com} % Second author's email address
}
\date{\vspace{-5ex}}
