...
New York City is home to millions of people who rely on its robust transportation system. The taxi transportation system in particular plays a critical role in keeping people moving throughout the city. With access to highly detailed NYC taxi data, we were able to explore some interesting questions about the taxi system. First, we wanted to get a basic understanding of where people go. By doing so, we could have an overview of the entire city and find out information such as which areas are popular, where the most taxis are situated, and even how traffic in New York City looks like. Next, we wanted to understand the roles of drivers in the taxi system. Specifically, we wanted to look at how efficient cab drivers are, and whether or they have skills that differentiate themselves from other drivers. Finally, we wanted to look at ways to improve the entire system, whether it be in terms of money, carbon emissions, or traffic. 

From our findings, we were able to get a bird's-eye view of taxis and reveal patterns in the movement of people throughout the city. Additionally, we analyzed driver efficiency and found that there is a substantial amount of skill involved in driving a taxi, with drivers consistently earning up to 30\% more than average. Finally, we found locations with many redundant trips in the city and showed that a simple carpooling strategy could shorten the number of trips and save money spent on cabs by approximately 5\%(600,000 trips, 8.5 million dollars).
