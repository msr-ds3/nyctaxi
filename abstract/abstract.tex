...
\begin{figure}[h]
  ...
  \captionof{figure}{Top carpooling hotspots sized by how frequent carpooling potentials occur. \\Notable hotspots are Penn Station, Grand Central Station, Lincoln Center, Metropolitan Museum of Art, High Line, and others. }
  \label{fig:hotspots}
\end{figure}
