...
taxi_drivers_count <- taxi_clean
taxi_drivers_count <- taxi_drivers_count %>% group_by(hack_license) %>% summarize(timedriving = sum(trip_time_in_secs))
...
taxi_driverss_Avg_length <- taxi_clean
...
taxi_drivers_Avg_fare <- taxi_clean
...
taxi_drivers_Avg_tip <- taxi_clean
...
taxi_drivers_total_fare <- taxi_clean
...
taxi_drivers_numTrip<- taxi_clean
...
taxi_drivers_medallion<- taxi_clean
